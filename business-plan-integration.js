...
window.BusinessPlanIntegration = (function () {
  ...
  function isBusinessPlanPage() {
    ...
    return currentPath.includes("/business-plan");
  }
  ...
  // Exit early if not on business plan page
  ...
  async function loadBusinessPlans() {
    console.log(`[${MODULE_NAME}] Loading business plans...`);
  ...
  function addCustomStyles() {
    ...
    if (document.getElementById("business-plan-styles")) {
      return;
    }

    const styleElement = document.createElement("style");
    styleElement.id = "business-plan-styles";
  ...
  /**
   * Initializes the business plan integration
   */
  function init() {
    console.log(`[${MODULE_NAME}] Business plan integration initialized`);
